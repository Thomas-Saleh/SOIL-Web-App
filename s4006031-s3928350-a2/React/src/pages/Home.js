...
function Home() {
  return (
    <div>
      ...
      {/* Section highlighting premium quality products */}
      ...
      {/* Sections for mission and values */}
      <div className="flex justify-center mt-8">
        {/* Mission section */}
        <section className="w-1/3 bg-white rounded-lg overflow-hidden shadow-md mx-4 mb-5">
          <div className="px-6 py-4">
